...
# 17 "env_maestro.c" 2
# 51 "env_maestro.c"
volatile unsigned char i2c_role = 0;
...
Prepare_LCD_Pins();
            ...
            if (asciiMode && key == '=') {
                ...
                asciiValue[0] = '\0';
                    ...
                    if (cursorPosition < 16 - 1) cursorPosition++;
                    if (charCount < 16) charCount++;
                }
...
void __attribute__((picinterrupt(("")))) ISR(void) {
    static char receiveBuffer[15 + 1];
    static int index = 0;
